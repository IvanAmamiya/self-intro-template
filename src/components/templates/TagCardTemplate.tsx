...
export default function TagCardTemplate({ data }: Props) {
  ...
  return (
    <article className="card card-tag" style={{ borderRadius: data.theme.borderRadius }}>
      <header className="card-head">
        ...
        <div>
          ...
          <p>
            {[data.gender, data.region, data.mbti].filter(Boolean).join(' · ') || tx('emptyBasicInfo')}
          </p>
        </div>
      </header>
